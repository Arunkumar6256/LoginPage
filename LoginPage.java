...
public class LoginPage {
    ...
    public static void datapage(){
        ...
        System.out.println("Institute of Aeronautical Engineering (IARE) is a private engineering college in Hyderabad. The college offers post graduate (Masters) and undergraduate (Bachelors) courses in engineering and technology.\r\n" + //
                        "\r\n" + 
